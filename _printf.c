...
void print_bffer(char buffer[], int *buff_ind);

/**
 * _printf - Printf function that prodices output acc to a format
 * @format: the format.
 ...
 * @buff_ind: Index at which to add next char is the length.
 */
